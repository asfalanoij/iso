...
const ANNEX_CONTROL_CROSSWALK = [
  {
    ...
    controls: [
      { id: 'A.5.1', title: 'Policies for information security', applicableStandards: ['iso27001', 'iso27701', 'iso20000', 'iso22301', 'iso45001', 'iso37001', 'iso50001'], crossRef: { iso27701: '6.2.1.1', iso37001: '5.2', iso22301: '5.2', iso20000: '5.2', iso45001: '5.2', iso50001: '5.2' }, note: 'Every MS requires a policy; single integrated policy document can satisfy all' },
      { id: 'A.5.2', title: 'Information security roles and responsibilities', applicableStandards: ['iso27001', 'iso27701', 'iso20000', 'iso45001', 'iso37001', 'iso50001'], crossRef: { iso27701: '5.3.3', iso37001: '5.3', iso20000: '5.3', iso45001: '5.3', iso50001: '5.3' }, note: 'Roles matrix shared across all standards' },
      ...
      { id: 'A.5.4', title: 'Management responsibilities', applicableStandards: ['iso27001', 'iso27701', 'iso20000', 'iso45001', 'iso37001', 'iso50001'], crossRef: { iso37001: '5.1.1', iso45001: '5.1' }, note: 'Leadership commitment clause in every standard' },
      ...
      { id: 'A.5.19', title: 'Information security in supplier relationships', applicableStandards: ['iso27001', 'iso27701', 'iso20000', 'iso37001'], crossRef: { iso37001: '8.5', iso20000: '8.3.4' }, note: 'ABMS business associate controls (8.5); ITSMS supplier management (8.3.4)' },
      ...
      { id: 'A.5.30', title: 'ICT readiness for business continuity', applicableStandards: ['iso27001', 'iso20000', 'iso22301'], crossRef: { iso22301: '8.3', iso20000: '8.7.2' }, note: 'New in 2022; BCMS integration; ITSMS service continuity (8.7.2)' },
      { id: 'A.5.31', title: 'Legal, statutory, regulatory and contractual requirements', applicableStandards: ['iso27001', 'iso27701', 'iso45001', 'iso37001', 'iso50001'], crossRef: { iso45001: '6.1.3', iso37001: '4.2' }, note: 'OHS legal requirements (6.1.3); ABMS stakeholder requirements (4.2)' },
  ...
  },
  {
    ...
    controls: [
      ...
      { id: 'A.6.2', title: 'Terms and conditions of employment', applicableStandards: ['iso27001', 'iso27701', 'iso45001', 'iso37001'], crossRef: { iso37001: '8.6', iso45001: '7.2' }, note: 'ABMS anti-bribery commitments (8.6); OHS worker competence' },
      { id: 'A.6.3', title: 'Information security awareness, education and training', applicableStandards: ['iso27001', 'iso27701', 'iso20000', 'iso45001', 'iso37001', 'iso50001'], crossRef: { iso37001: '7.3', iso45001: '7.3', iso50001: '7.3' }, note: 'Shared awareness programme across all standards' },
      ...
      { id: 'A.6.8', title: 'Information security event reporting', applicableStandards: ['iso27001', 'iso27701', 'iso45001', 'iso37001'], crossRef: { iso37001: '8.10', iso45001: '10.2' }, note: 'ABMS raising concerns/whistleblowing (8.10); OHS incident reporting (10.2)' },
    ]
  },
  {
    ...
    controls: [
      ...
      { id: 'A.7.5', title: 'Protecting against physical and environmental threats', applicableStandards: ['iso27001', 'iso22301', 'iso45001'], crossRef: { iso45001: '8.2', iso22301: '8.2.3' }, note: 'OHS emergency preparedness; BCMS risk assessment' },
      ...
      { id: 'A.7.11', title: 'Supporting utilities', applicableStandards: ['iso27001', 'iso22301', 'iso50001'], crossRef: { iso50001: '8.1', iso22301: '8.3.3' }, note: 'Power/cooling; EnMS operational controls; BCMS resource requirements' },
  ...
  },
  {
    ...
    controls: [
      ...
      { id: 'A.8.14', title: 'Redundancy of information processing facilities', applicableStandards: ['iso27001', 'iso20000', 'iso22301'], crossRef: { iso22301: '8.3.3', iso20000: '8.7.1' }, note: 'BCMS resource requirements; ITSMS service availability' },
